                ...
                <div className="container my-3">
                    ...
                    <form className="my-3">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="Projectname" name="Projectname" aria-describedby="emailHelp" value={pro.Projectname} onChange={onChange} minLength={5} maxLength={35} required />
